...
import './About.css';
import '../../css/styles.css'; // Assuming styles.css is in the src directory
      ...
      <div className="container">
        ...
        <div className="about-content">
          ...
          <div className="about-text">
            ...
            <a href="path/to/your-resume.pdf" className="resume-button button" download>Download Resume</a> {/* Added 'button' class */}
          </div>
        </div>
      </div>
    </section>
